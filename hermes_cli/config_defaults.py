...
DEFAULT_CONFIG = {
    ...
    "auxiliary": {
        ...
        # reply remains unchanged; this task only produces a bounded script.
        "tts_spoken_rewrite": {
            "provider": "custom",
    ...
    "tts": {
        ...
        "provider": "edge",
        "spoken_rewrite": {
            # Opt-in: wait for the complete reply, rewrite it once, and fail
            # closed rather than speaking the raw reply if validation fails.
            "enabled": False,
            ...
            "observability": {"enabled": True, "capture_script": False},
        },
        "edge": {
