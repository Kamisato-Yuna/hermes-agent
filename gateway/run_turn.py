...
class GatewayTurnMixin:
    ...
    def _run_agent_start_streaming_tts(
        ...
        try:
            ...
            if spoken_rewrite_enabled(_tts_cfg.get("spoken_rewrite") if isinstance(_tts_cfg, dict) else None):
                logger.info("Streaming TTS disabled for this turn: semantic spoken rewrite waits for full reply")
                return
