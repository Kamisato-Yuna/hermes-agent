...
def _probe_teams_sdk_available() -> bool:
    ...
    try:
        ...
        # trust an orphaned child left in ``sys.modules``; it must be attached
        # to the current parent namespace object.
        parent = sys.modules.get("microsoft_teams")
        apps = sys.modules.get("microsoft_teams.apps")
